...
task('sendAdapter1', 'Sends tokens from OFTAdapter')
    ...
    .setAction(async (taskArgs: Args, {ethers, deployments}) => {
        ...
        const stroptions = decoder.decode(options);
        ...
        console.log('----- 2.1')
        console.log('----- 2', eidB, signer.address, innerToken.address, amount.toString(), stroptions.toString())
        console.log('----- 2.2')

        // console.log('----- 2 sendParam = ', sendParam)
        console.log('----- 2 sendParam.to = ', addressToBytes32(toAddress).toString(16), toAddress) //addressToBytes32(toAddress).toString(16)
        console.log('----- 2 sendParam.options = ', options.toString(16), oft.address, oft.signer.getAddress())
